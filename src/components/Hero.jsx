    ...
    <div>
        ...
        <div className='relative overflow-hidden font-Dm-Sans'>
            ...
            <div className='absolute w-full top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2  flex items-center justify-center flex-col '>
                ...
                <button className='hidden lg:flex bg-blue-500 text-white px-4 py-2 text-xl items-center justify-center gap-x-2 group cursor-pointer rounded-md'>
                    See Collection<ArrowRight className='group-hover:translate-x-1 transition-all duration-75 ease-in' size={20}  strokeWidth={1.5}  absoluteStrokeWidth={true} /></button>
            </div>
